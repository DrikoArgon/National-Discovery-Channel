...
public class SoundGuy : MonoBehaviour {
	...
	public GameObject boomCaptionDown;
	public GameObject boomCaptionLeft;
	public GameObject boomCaptionRight;
	public GameObject boomCaptionUp;
...
//					if(doingAction){
//						boomCaptionUp.SetActive(true);
//						boomCaptionDown.SetActive(false);
//						boomCaptionLeft.SetActive(false);
//						boomCaptionRight.SetActive(false);
//					}
					MoveUp();
				}
			} else{
...
//				}
			...
			if(tooFar){
				...
				if(distanceAfterMovement < distanceToCameraGuy){
//					if(doingAction){
//						boomCaptionUp.SetActive(false);
//						boomCaptionDown.SetActive(false);
//						boomCaptionLeft.SetActive(false);
//						boomCaptionRight.SetActive(true);
//					}
					MoveRight ();
				}
			} else{
...
//						boomCaptionUp.SetActive(false);
//						boomCaptionDown.SetActive(false);
//						boomCaptionLeft.SetActive(true);
//						boomCaptionRight.SetActive(false);
//					}
					MoveLeft ();
				}
...
//					if(doingAction){
//						boomCaptionUp.SetActive(false);
//						boomCaptionDown.SetActive(true);
//						boomCaptionLeft.SetActive(false);
//						boomCaptionRight.SetActive(false);
//					}
					MoveDown ();
